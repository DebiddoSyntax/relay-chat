    ...
    return (
        <div className="pt-40 md:pt-40 lg:pt-52  bg-gray-bg pb-40 px-5 md:px-10 lg:px-20 h-screen">
            {!emailSent ?  (
                ...
                <div  className='px-8 md:px-8 py-5 md:py-8 bg-background w-full md:w-[70%] lg:w-[50%] mx-auto rounded-md hover:shadow-lg'>
                    ...
                    <button type='submit' className='mt-8 mx-auto bg-primary w-full py-4 rounded-md text-sm md:text-base text-center font-semibold text-white cursor-pointer'
                        disabled={loading} 
